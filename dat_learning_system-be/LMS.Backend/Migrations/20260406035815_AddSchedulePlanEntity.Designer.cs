...
namespace LMS.Backend.Migrations
{
    ...
    [Migration("20260406035815_AddSchedulePlanEntity")]
    partial class AddSchedulePlanEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Backend.Data.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CompanyCode = "00-0000",
                            ConcurrencyStamp = "ada260e8-6f9c-45ed-a351-d82793038e06",
                            Email = "admin@lms.com",
                            EmailConfirmed = true,
                            ...
                            OrgUnitId = 1,
                            PasswordHash = "AQAAAAIAAYagAAAAEMjTnPe94GbFgFiNF88drsyfcZXiipE5mrRdUekwVnOt5IydE8XoXVU+eLfLC1YcuA==",
                            PhoneNumberConfirmed = false,
                            Position = 0,
                            SecurityStamp = "d1bbc2c8-7674-4ce1-9728-430ab093c9c1",
            ...
            modelBuilder.Entity("LMS.Backend.Data.Entities.RoadMap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LMS.Backend.Data.Entities.SchedulePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TargetPositions")
                        .HasColumnType("text");

                    b.Property<string>("TargetUserCodes")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("LMS.Backend.Data.Entities.Test", b =>
                {
                    ...
                    b.HasIndex("Title", "Version", "IsGlobal")
                        .IsUnique();
