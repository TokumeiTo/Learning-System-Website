...
const DraftBlock = ({ block, updateBlock, removeBlock }: any) => {
    ...
    // Local state to toggle between 'upload' and 'link'
    ...
    const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                updateBlock(block.tempId, reader.result as string);
            };
                    ...
                    {block.contentType === 'text' && (
                        <TextField
                            ...
                            InputProps={{
                                ...
                                sx: { color: 'white', lineHeight: 1.7, fontSize: '1.05rem', whiteSpace: 'pre-wrap' }
                            }}
                        />
                    )}
